  ...
  return(
    <div style={{position:'relative',width:W,height:H,flexShrink:0}}>
      <svg width={W} height={H} viewBox={"0 0 "+W+" "+H} style={{position:'absolute',top:0,left:0}}>
        ...
        <path d={"M "+(W*0.34)+" "+(H*0.2+6)+" A "+(W*0.2)+" "+(W*0.2)+" 0 0 1 "+(W*0.66)+" "+(H*0.2+6)} fill="none" stroke={lc} strokeWidth="1.2"/>
        ...
        <path d={"M "+(W*0.34)+" "+(H-6-H*0.2)+" A "+(W*0.2)+" "+(W*0.2)+" 0 0 0 "+(W*0.66)+" "+(H-6-H*0.2)} fill="none" stroke={lc} strokeWidth="1.2"/>
